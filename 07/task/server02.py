...
class Server:
    ...
    def __init__(self, paramsNameSpace, logger):
        ...
        self.response = {
            ...
            'authorization': {
                ...
                'passName': {
                    'response': 402,
                    'alert': 'Пользователь с таким именем уже зарегистриован или Вы ввели не верный пароль'
                },
            },
        }
    ...
    def authorization(self, client, data, condition):
        ...
        if oLen == 1:
            if user['login'] in self.clients.keys() and user['pass'] == self.clients[user['login']]:
